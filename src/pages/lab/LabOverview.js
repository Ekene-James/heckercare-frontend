...
import LabRequestTable from "components/molecules/tabels/lab/LabRequestTable";
import CustomBarChart from "components/atoms/CustomBarChart";

import CustomButton from "components/atoms/CustomButton";
import LabHistoryTable from "components/molecules/tabels/lab/LabHistoryTable";
import Pagination from "components/molecules/pagination/Pagination";
import { useNavigate } from "react-router-dom";
import CustomModal from "components/atoms/CustomModal";
import DashboardModalView from "components/molecules/lab/modalContents/DashboardModalView";
...
function LabOverview({ dropDownContent }) {
  ...
  const { data: stats, isLoading: statsLoading } = useCustomQuery(
    [GET_INVESTIGATION_TEST_STATS, { departmentType: "LABORATORY" }],
    {
      url: `/investigation/test-stats?departmentType=LABORATORY`,
      method: "get",
  ...
  const handleExport = () => {
    exportToExcel(
      ...
      `lab_history_${new Date()}`
    );
  };

  return (
    <Box>
      <Typography variant="displayLg">Laboratory</Typography>
            ...
            >
              ...
              {upcomingReqData?.data?.filteredInvestigations?.length ? (
                <Button
                  ...
                  onClick={() => navigate("/home/all-laboratory-requests")}
                  color="secondary"
                >
                  {" "}
