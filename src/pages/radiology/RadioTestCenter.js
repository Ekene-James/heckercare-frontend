...
import TestDescription from "components/molecules/radio/TestDescription";
import CustomModal from "components/atoms/CustomModal";
import TestCenterModalView from "components/molecules/radio/modalContents/TestCenterModalView";
...
const now = new Date();
function RadioTestCenter({ dropDownContent, testDesc }) {
  ...
  const {
    ...
    [GET_RADIOLOGY_TEST_INFO, search, "RADIOLOGY"],
    {
      url: `/laboratory/test-center`,
      method: "post",
      data: { search, departmentType: "RADIOLOGY" },
    },
    {
      refetchOnWindowFocus: false,
      enabled: false,
...
export default RadioTestCenter;
