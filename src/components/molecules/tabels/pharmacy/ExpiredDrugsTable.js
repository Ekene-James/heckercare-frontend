...
export default function ExpiredDrugsTable({
  refetch,
  data,
  checkBoxItems,
  setcheckBoxItems,
  ...
  return (
    <>
      ...
      {/* <RightDrawer open={showOrderForm} setOpen={setShowOrderForm}>
        <CreateDrugOrder />
      </RightDrawer> */}
      <RightDrawer
        open={Boolean(requestDetail)}
        closeHandler={() => setRequestDetail(null)}
        title="Expired Drug Detail"
      >
        <ExpiredDrugDetails editData={requestDetail} />
      </RightDrawer>
    </>
  );
}
