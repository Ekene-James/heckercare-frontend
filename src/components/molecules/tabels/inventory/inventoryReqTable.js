...
import ViewRequisitionModal from "components/molecules/inventory/modalContent/requisitionModals/viewRequisition/ViewRequisitionModal";
...
export default function InventoryReqTable({ data }) {
