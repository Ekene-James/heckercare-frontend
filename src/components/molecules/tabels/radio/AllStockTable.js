...
import { GET_ALL_STOCKS, GET_RADIOLOGY_STOCKS } from "utils/reactQueryKeys";
...
export default function AllStockTable({ data, currentPage, handlePageChange }) {
  ...
  const {
    ...
    [GET_RADIOLOGY_STOCKS, search],
    {
      url: `/radiology-stock/?search=${search}`,
      method: "get",
    },
    {
