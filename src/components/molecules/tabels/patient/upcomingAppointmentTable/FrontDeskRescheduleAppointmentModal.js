...
function FrontDeskRescheduleAppointmentModal({
  refetch,
  modalContent,
  closeModal,
  currentPage,
        ...
        <Grid item xs={12} sm={10}>
          <Grid container spacing={1}>
            <Grid item xs={12} sm={4}>
              <CustomTextInput
                title="Patient"
                value={`${modalContent?.patient?.firstName} ${modalContent?.patient?.lastName}`}
                disabled="true"
                readOnly
              />
            </Grid>
...
export default FrontDeskRescheduleAppointmentModal;
