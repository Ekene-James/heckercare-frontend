...
export default function RadiologyTable() {
  ...
  const { data, isLoading: tableLoading } = useCustomQuery(
    [GET_PATIENT_INVESTIGATION, id, "RADIOLOGY"],
    {
      url: `/investigation/get-patient-investigations/${id}?departmentType=RADIOLOGY&testStatus=PENDING`,
      method: "get",
    },
    {
